    ...
    <div style={{ position: "relative", width: "100%", overflow: "hidden", background: "#fff" }}>
      ...
      >
        <div style={{ maxWidth: 980, margin: "0 auto", padding: "0 40px" }}>
          ...
          >
            UX-driven software for humans and enterprises
          </h1>
          <p style={{ fontSize: 19, lineHeight: 1.55, color: "#6b6875", maxWidth: 640, margin: "22px auto 0" }}>
            Design, engineer, and automate with one lab — flexible scope,
            production reliability, and research built in.
          </p>
            ...
            >
              ...
              <div className="stack-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
                <div style={{ padding: 22, borderRight: "1px solid rgba(14,13,18,.06)" }}>
                  ...
                  <div style={{ fontWeight: 500, fontSize: 19, marginTop: 6 }}>One team, four disciplines</div>
      ...
      <section style={{ background: "#fff", padding: "100px 0 20px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px" }}>
          <h2 style={centerH2}>Why MindfulTech?</h2>
          <p style={centerSub}>
            Research-led design, production-grade engineering, and enterprise
            reliability — at any scale.
          </p>
          <div className="stack-3" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 26 }}>
            {[
              ["#bdd9f0", "#2c3a4a", "Faster delivery & iteration", "Reusable design systems and AI-assisted engineering cut build time — without cutting corners on quality."],
              ["#f2cfe3", "#4a3040", "Predictable scope & budget", "Research before build means fewer surprises. Fixed milestones, transparent reporting, no scope drift."],
              ["#f8d9c3", "#4c3628", "Production reliability & security", "AWS architectures with observability, backups, and encryption in transit and at rest — from day one."],
      ...
      <section style={{ background: "#fff", padding: "90px 0 30px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px" }}>
          <h2 style={{ ...centerH2, marginBottom: 48 }}>What we build</h2>
          <div className="stack-4" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 18 }}>
            {SERVICE_CARDS.map((c) => (
              ...
              >
                ...
                <div style={{ fontWeight: 600, fontSize: 18.5, letterSpacing: "-.01em" }}>{c.title}</div>
                <div style={{ display: "flex", flexDirection: "column", gap: 10, fontSize: 13 }}>
                  {c.rows.map(([k, v]) => (
                    <div key={k}>
                      <div style={{ fontFamily: MONO, fontSize: 10.5, letterSpacing: ".1em", color: "#8b8896" }}>{k}</div>
        ...
        >
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <span style={{ fontWeight: 600, fontSize: 20 }}>Managed delivery</span>
            </div>
            ...
            <p style={{ fontSize: 16, lineHeight: 1.6, color: "#55525e", margin: "18px 0 22px", maxWidth: 460 }}>
              Ship production workloads without building a team first. Design,
              engineering, QA, and cloud operations arrive pre-configured — you
              keep ownership of every repo and account.
            </p>
      ...
      <section style={{ background: "#fff", padding: "60px 0 90px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px" }}>
          <DarkCTA
            title="Start building with MindfulTech"

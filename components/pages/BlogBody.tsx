...
const POSTS: { href: string; bg: string; onDark: boolean; tag: Bi; title: Bi; body: Bi }[] = [
  {
    href: "/work#usfq",
    ...
    title: {
      en: "USFQ: a campus portal 12,000 students actually use",
      es: "USFQ: un portal que 12.000 estudiantes sí usan",
    },
    body: {
      en: "Adoption tripled after we rebuilt onboarding around real course-planning behavior…",
      es: "La adopción se triplicó tras rediseñar el onboarding según el comportamiento real…",
    },
  },
  {
    href: "/work#helixona",
    ...
    title: {
      en: "How we cut Helixona’s fulfillment time with automation",
      es: "Cómo redujimos los tiempos de Helixona con automatización",
    },
    body: {
      en: "Order processing dropped from hours to minutes with AI-checked workflows…",
      es: "El procesamiento de pedidos pasó de horas a minutos con flujos verificados por IA…",
    },
  },
  {
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px" }}>
          ...
          >
            ...
            <a href="mailto:info@mindfultech.ec?subject=Blog" style={{ textDecoration: "none", color: "var(--ink)", display: "block" }}>
              ...
              >
                <ImagePlaceholder label={es ? "IMAGEN DESTACADA" : "FEATURED IMAGE"} />
              </div>
              <span
                style={{
